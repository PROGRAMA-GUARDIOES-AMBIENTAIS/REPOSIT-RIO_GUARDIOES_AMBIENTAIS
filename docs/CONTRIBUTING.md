...
> nomes específicos de responsáveis **não devem ser criados sem validação**. consultar [`docs/01_projeto/governanca.md`](./01_projeto/governanca.md).
...
detalhes sobre aprovação, revisão e versionamento: [`docs/01_projeto/governanca.md`](./01_projeto/governanca.md).
